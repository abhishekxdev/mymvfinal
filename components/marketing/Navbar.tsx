  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 mt-2">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-black/80 backdrop-blur-md border border-neutral-800 rounded-full px-6 flex items-center justify-between py-2 md:py-4">
          <Link href="/" className="flex items-center space-x-3">
            ...
            <span className="font-normal text-base md:text-lg text-white">MVP Studio</span>
          </Link>
