...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col md:border-r py-8 relative group/feature border-white/20",
    ...
    >
      ...
      <div className="mb-6 relative z-10 px-8 text-white/80">
      ...
      <p className="text-sm text-white/80 max-w-xs relative z-10 px-8 leading-relaxed">
        {description}
      </p>
    </div>
  )
